...
## [注释](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Guide/Grammar_and_Types#注释)
...
### [变量的作用域](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Guide/Grammar_and_Types#变量的作用域)
...
### [函数提升](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Guide/Grammar_and_Types#函数提升)
...
need links to pages discussing scope chains and the global object 实际上，全局变量是*全局对象*的属性。在网页中，（译注：缺省的）全局对象是 `window` ，所以你可以用形如 `window.`*`variable`* 的语法来设置和访问全局变量。
...
### [常量(Constants)](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Guide/Grammar_and_Types#常量constants)
...
### [数据类型的转换](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Guide/Grammar_and_Types#数据类型的转换)
...
## [字面量 (Literals)](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Guide/Grammar_and_Types#字面量_literals)
